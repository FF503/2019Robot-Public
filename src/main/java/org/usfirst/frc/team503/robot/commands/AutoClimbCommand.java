...
public class AutoClimbCommand extends CommandGroup {
  /**
   * Add your docs here.
   */
  public AutoClimbCommand() {
    ...
    addSequential(new FollowPitchPID(Robot.bot.targetPitch));

    // Start the elevation segment relative to robot pitch
    addSequential(new ClimbElevatorPID(Robot.bot.elevatorTarget));

    // Puts more drive into hab
    addParallel(new ConstantDriveCommand(-0.20));
    ...
    // do wind up
    addParallel(new WindupClimberCommand());
  }
}
