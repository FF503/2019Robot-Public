 ...
 */
public class FroggyDriveHelperRebase {
    ...
    private static final double kLowSensitiity = 0.75;
    ...
    private static FroggyDriveHelperRebase instance = new FroggyDriveHelperRebase();

    public static FroggyDriveHelperRebase getInstance() {
        return instance;
    }

    public void froggyDrive(double throttle, double wheel, boolean isQuickTurn, boolean isHighGear) {
        ...
        if (isQuickTurn) {
            ...
            if (Math.abs(linearPower) < 0.2) {
                angularPower = 0.6 * wheel * sensitivity - mQuickStopAccumlator;
            } else {
        ...
        Drive.getInstance().setMotorOutputs(leftPwm, rightPwm);
        ;
    }
