...
import org.usfirst.frc.team503.robot.vision.uselessstuff.VisionPath;

import edu.wpi.first.networktables.NetworkTableInstance;
import edu.wpi.first.wpilibj.command.Command;
import motionProfiling.Trajectory;

public class VisionSplineFollower extends Command {
	private PurePursuitDrive purePursuitDriveCommand;

	public VisionSplineFollower() {
	...
	protected boolean isFinished() {
		return purePursuitDriveCommand.isCompleted();
	}
