...
public class RobotHardwarePracticeBot extends RobotHardware {
	...
	public final int kCurrentLimit = 55;
	...
	public final double turnSensitivity = 2.00;
	...
	public final double PIVOT_P = 0.008;
	...
	public String ARM_LIMELIGHT = "limelight-a";
	...
	/**************************************************************************************/
	{
		...
		forwardLimelightAreaThreshold = 6;
