...
public class TeleopFollowToPlace extends Command {
	...
	public TeleopFollowToPlace() {
		RobotState.getInstance().setAutonToleranceAdjustment(0.0);
	}

	public TeleopFollowToPlace(double autonToleranceAdjustment){
		RobotState.getInstance().setAutonToleranceAdjustment(autonToleranceAdjustment);
	}

	public TeleopFollowToPlace(PipelineSelector pipelineMode, double autonToleranceAdjustment) {
		RobotState.getInstance().setAutonToleranceAdjustment(autonToleranceAdjustment);
