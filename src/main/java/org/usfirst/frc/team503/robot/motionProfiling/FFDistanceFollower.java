...
public class FFDistanceFollower {
    ...
    public FFDistanceFollower(Trajectory traj) {
        this.trajectory = traj;
    }

    public FFDistanceFollower() {
    }
    ...
    public double calculate(double distance_covered) {
        ...
        if (segment < trajectory.length()) {
            ...
            double error = seg.x - distance_covered;
            SmartDashboard.putNumber("Elevator motion profile error", error);
