 ...
 */
public class DriveStraightNew extends Command {
    ...
    protected void initialize() {
        ...
        System.out.println("DriveStraight: Left Dist:" + df.format(initLeftDist) 
         + " Right Dist:" + df.format(initRightDist) 
         + " Ang:" + df.format(angle));

        System.out.println("Setpoint: (" + finalPt[0] + ", " + finalPt[1] + ")"
         + " Atempt to drive:" + df.format(distanceForDrive) 
        );
    ...
    protected void execute() {
        ...
        if (!straightPID.onTarget(tolerance)) {
            ...
            System.out.println("DriveStraight Traveled: " + df.format(distanceTraveled) 
            + " power:" + df.format(power));
